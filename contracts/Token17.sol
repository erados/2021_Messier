...
contract Token17 is KIP17Token, Ownable {
   ...
   */
  function setCurrency(KIP7Spendable newMintingCurrency) external onlyOwner {
   ...
   *
   */
  function create(uint256 dataHash) external returns (uint256) {
  ...
  function buyingSneakers(uint256 num, uint256 price)
    public
    equalPrice(num, price)
  {
